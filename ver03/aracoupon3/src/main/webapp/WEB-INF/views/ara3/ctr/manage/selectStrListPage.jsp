...
<%@ include file="/WEB-INF/views/ara2/common/modalSelfInfoCtr.jsp"%>
	...
	<!-- ////////////////////////////////////////////////////////////////////////////////////////////// -->
	<div class="row">
		<div class="modal" id="modalStrInfo" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header alert alert-success">
						가게 정보<button class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body text-center">
						<table class="table text-left">
							<tr>
								<td>가게 번호</td>
								<td><div id="modalStrNo"></div></td>
							</tr>
							<tr>
								<td>가게 ID</td>
...
<script type="text/javascript">
	...
	function selectList() {
		if (true) console.log(">>>>> ", arguments.callee.caller);
		jQuery.ajax({
			url           : "${staticPATH}/ctr2/manage/selectStrInfoList.do",
			dataType      : "JSON",
			scriptCharset : "UTF-8",
			type          : "POST",
