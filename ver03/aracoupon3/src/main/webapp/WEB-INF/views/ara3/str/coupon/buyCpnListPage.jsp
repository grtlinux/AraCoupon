					...
					<table id="campTable" class="table table-hover table-condensed">
						<thead>
							<tr class="success text-center">
								...
								-->
								<td class='text-danger'>남음 / 구매함 / 전체</td>
								<td class='hide'>쿠폰합계</td>
								<td>캠페인기간</td>
								<td>쿠폰마스터</td>
								<!--
								<td>캠페인내</td>
			...
			success: function(result, option) {
				if (option == "success"){
					...
					list.forEach(function(value, index, array) {
						...
						//rowHtml += "  </td>";
						rowHtml += "  <td class='text-center text-danger'>";
						rowHtml += "    " + value.RMN_CNT + " / " + value.BUY_CNT + " / " + value.TTL_CNT;
						rowHtml += "  </td>";
						rowHtml += "  <td class='text-center numberToMoney hide'>";
						rowHtml += "    " + value.CPN_SUM;
						rowHtml += "  </td>";
						rowHtml += "  <td>";
						rowHtml += "    " + value.BGN_DT + " ~ " + value.END_DT;
						rowHtml += "  </td>";
