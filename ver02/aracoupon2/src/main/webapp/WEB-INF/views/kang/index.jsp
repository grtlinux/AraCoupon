...
<head>
	...
	<!--
	<base href="http://arajeju.com:8080/" target="_self">
	<base href="http://172.30.1.20:8080/" target="_self">
	<base href="http://192.168.1.117:8080/" target="_self">
	-->
	<title>테스트 용도</title>
</head>
<!-- style -->
...
<link rel="stylesheet" href="/bootstrap3/css/codingBooster.css">
<style type="text/css">
	.jumbotron {
			...
			<div class="panel-body">
				<div class="media">
					<div class="media-left">
						<a href="#"><img class="media-object" src="/bootstrap3/images/CAN.jpg" style="width:100px;" alt="강의 이미지 1"></a>
					</div>
				...
				<div class="media">
					<div class="media-left">
						<a href="#"><img class="media-object" src="/bootstrap3/images/PNG.jpg" style="width:100px;" alt="강의 이미지 2"></a>
					</div>
					<div class="media-body">
				...
				<div class="media">
					<div class="media-left">
						<a href="#"><img class="media-object" src="/bootstrap3/images/SQL.jpg" style="width:100px;" alt="강의 이미지 3"></a>
					</div>
					<div class="media-body">
			...
			<div class="col-xs-12">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="media">
							<div class="media-left">
								<a href="#"><img class="media-object" src="/bootstrap3/images/steve-jobs.png" style="width:50px;"></a>
							</div>
							<div class="media-body">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						...
						<img src="/bootstrap3/images/LEGO_Logo.jpg" style="width:250px;">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						저희 서비스의 특징은 바로 강의를 들을 수 있다는 점입니다.<br>
						특히 다양한 무료 강의가 유튜브와 연동되어 제공됩니다.<br><br>
						<img src="/bootstrap3/images/JPG-logo-highres.jpg" style="width:250px;">
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function fn_getIndex(){
		jQuery.ajax({
			//url           : "http://arajeju.com:8080/Kang/getIndex.do?serverType=IMSI",
			url           : "/Kang/getIndex.do?serverType=IMSI",
			dataType      : "JSON",
			scriptCharset : "UTF-8",
			type          : "POST",
			//data          : $("#form").serialize(),
